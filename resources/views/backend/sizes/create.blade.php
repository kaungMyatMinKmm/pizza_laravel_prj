	        ...
	        <div class="card-body">
	            ...
	            <form action="{{route('sizes.store')}}" method="POST" enctype="multipart/form-data">
	            	...
	            	<div class="form-group row">
				    	...
				    	<div class="col-sm-10">
				      		<input type="number" class="form-control @error('price') is-invalid @enderror" id="inputPrice" placeholder="Enter Price" name="price" value="{{old('price')}}" required="" autocomplete="price" autofocus>
				      		@error('price')
					...
					<div class="form-group row">
				    	...
				    	<div class="col-sm-10">
				      		<input type="text" class="form-control @error('name') is-invalid @enderror" id="inputName" placeholder="Enter Name" name="name" value="{{old('name')}}" required="" autocomplete="price" autofocus>
				      		@error('name')
				      		<span class="invalid-feedback" role="alert">
				      			<strong>{{$message}}</strong>
				      		</span> 
