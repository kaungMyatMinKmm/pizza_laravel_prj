	        ...
	        <div class="card-body">
	            ...
	            <form action="{{route('tables.store')}}" method="POST" enctype="multipart/form-data">
	            	...
	            	<div class="form-group row">
				    	...
				    	<div class="col-sm-10">
				      		<input type="text" class="form-control @error('table') is-invalid @enderror" id="inputTable" placeholder="Enter Table No" name="table" value="{{old('table')}}" required="" autocomplete="table" autofocus>
				      		@error('table')
